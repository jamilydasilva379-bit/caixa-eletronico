...
public class Withdrawal extends Transaction {
    ...
    public void execute() {
        ...
        double avaliableBalance; // quantia disponível para saque
        ...
        do {
            ...
            if (amount != CANCELED) {
                ...
                avaliableBalance = bankDatabase.getAvaliableBalance(getAccountNumber());
                ...
                if (amount <= avaliableBalance) {
                    ...
                    if (cashDispenser.isSufficientCashAvaiable(amount)) {
